...
define QT5BASE_CONFIGURE_CMDS
	...
	(cd $(@D); \
		...
		-device-option BR_COMPILER_CFLAGS="$(TARGET_CFLAGS) $(QT5BASE_EXTRA_CFLAGS) -mfpu=neon-vfpv4" \
		-device-option BR_COMPILER_CXXFLAGS="$(TARGET_CXXFLAGS) $(QT5BASE_EXTRA_CFLAGS) -mfpu=neon-vfpv4" \
		$(QT5BASE_CONFIGURE_OPTS) \
	)
endef
